...
public class ExcelImportUtil {
	...
	public static ExcelData readExcel(InputStream xmlFile, InputStream importExcelStream) throws ExcelImportException {
		return readExcel(xmlFile, importExcelStream, 0);
	}
	 ...
	 * @return Excel中需要导入的数据
	 */
	public static ExcelData readExcel(InputStream xmlFile, InputStream importExcelStream, int sheetIndex) throws ExcelImportException {
		...
		try {
			...
			return ExcelDataReader.readExcel(excelStruct, importExcelStream, sheetIndex);
